...
cd /d "C:\Users\sohag\Downloads\GitHub_Upload\Extract YouTube M3U8 Stream Link"

IF NOT EXIST ".git" (
    echo Initializing new Git repository...
    git init
	git remote add origin https://github.com/sohag1192/SN_BOT-For-The-Telegram.git
